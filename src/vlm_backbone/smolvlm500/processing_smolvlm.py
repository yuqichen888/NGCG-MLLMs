...
def _prompt_split_image(
    ...
    text_split_images = ""
    # print("processing_smolvlm,line 65, image_seq_len:",image_seq_len)
...
class SmolVLMProcessor(ProcessorMixin):
    ...
    def process_vision(self, text, images, output_kwargs):
        ...
        # print("n_images_in_text", n_images_in_text)
        # print("n_images_in_images", n_images_in_images)
        ...
        for sample, sample_rows, sample_cols in zip(text, image_rows, image_cols):
            ...
            for n_rows, n_cols in zip(sample_rows, sample_cols):
                ...
                # print("image_prompt_string:",image_prompt_string)
    ...
    def __call__(
        ...
        **kwargs: Unpack[SmolVLMProcessorKwargs],
        ...
        # 在 return BatchFeature(inputs, tensor_type=return_tensors) 之前
