...
#
# import torch
# from official.vision.utils.object_detection.box_list_ops import height_width
...
# from transformers.utils import LossKwargs, can_return_tuple, logging,auto_docstring
...
#         # print("enter embedding function")
...
#         print("modeling_smolvlm.line171.self.dropout", self.dropout)
...
#     def forward(
#         self,
#         pixel_values, # shape:[bs*num_imgs, num_channel, h, w]
...
#         # print("after embedding:",hidden_states.size())
...
#         # print("x3.view().size():", x.size())
#         x = x.permute(0, 2, 1, 3)
#         # print("x4.view().size():", x.size())
#         x = x.reshape(bsz, int(width / scale_factor), int(height / scale_factor), embed_dim * (scale_factor**2))
#         # print("x5.view().size():", x.size())
#         x = x.permute(0, 2, 1, 3)
#         # print("x6.view().size():", x.size())
#         x = x.reshape(bsz, int(seq / (scale_factor**2)), embed_dim * (scale_factor**2))
#         # print("x7.reshape().size():", x.size())
#         return x
#
#     def forward(self, image_hidden_states):
#         # print("connector")
#         # print("image_hidden_states in pixel shuffle", image_hidden_states.shape)
#         image_hidden_states = self.pixel_shuffle(image_hidden_states, self.scale_factor)
#         # print("after pixel_shuffle, image_hidden_states", image_hidden_states.shape)
#         image_hidden_states = self.modality_projection(image_hidden_states)
#         # print("after modality_projection, image_hidden_states", image_hidden_states.shape)
...
#         print("self.image_Sep_len:", self.image_seq_len)
#         print("config.vision_config.image_size:", self.config.vision_config.image_size)
#         print("config.vision_config.patch_size:", self.config.vision_config.patch_size)
#         print("config.scale_factor:", self.config.scale_factor)
#         print("========================================================")
...
#
#         image_embeds = torch.zeros_like(inputs_embeds,dtype=image_hidden_states.dtype,
...
#         """
#         # print("Encoding images into continuous embeddings...")
#         if pixel_values.dim() == 2:
#             return None
#         batch_size, num_images, num_channels, height, width = pixel_values.shape
#         # print("Pixel shape:", pixel_values.shape)
#         pixel_values = pixel_values.view(batch_size * num_images, *pixel_values.shape[2:])
#         # print("after view, Pixel shape:", pixel_values.shape)
...
#         # print("get_image_features-image_hidden_states:",image_hidden_states.shape)
#         # Modality projection & resampling
#         image_hidden_states = self.connector(image_hidden_states)
#         # print("after connector-image_hidden_states:",image_hidden_states.shape)
#         return image_hidden_states
#
#     @can_return_tuple
#     @auto_docstring(
...
#
#
#         # ... inside your forward method or where this check occurs ...
#         if inputs_embeds is None:
#             inputs_embeds = self.text_model.get_input_embeddings()(input_ids).to(dtype=self.dtype,device=input_ids.device)
#
#         # START VISUAL INPUTS INTEGRATION
#         if pixel_values is not None and image_hidden_states is not None:
#             raise ValueError("You cannot specify both pixel_values and image_hidden_states at the same time")
#         elif pixel_values is not None and pixel_values.dim()>2:
#             ### yuki(aug 15): change if: adding and pixel_values.dim()>2 for none image
